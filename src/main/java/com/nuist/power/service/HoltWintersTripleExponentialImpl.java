...
public class HoltWintersTripleExponentialImpl {
    ...
    //季节
    static Integer[] spring = new Integer[]{3,4,5};
    static Integer[] summer = new Integer[]{6,7,8};
    static Integer[] autumn = new Integer[]{9,10,11};
    static Integer[] winter = new Integer[]{12,1,2};
